  ...
  return (
    <div className="tc-app">
      ...
      <header className="tc-hero">
        <div className="tc-hero-content">
          ...
          <p className="tc-subtitle">
            ...
            detects mis-sorted waste, and glows with retro Screen Displays.
          </p>

          <div className="tc-hero-actions">
            <a
              href="https://github.com/ConnorKue/Trashcam"
              target="_blank"
              rel="noreferrer"
          ...
          <div className="tc-hero-diagram">
            ...
            <div className="tc-diagram-arrow">→</div>
            <div className="tc-diagram-node tc-diagram-node-muted">
              <span className="tc-diagram-label">Display</span>
              <span className="tc-diagram-desc">Retro Theme touchscreen display</span>
            </div>
          </div>
        </div>
      </header>
        ...
        <section id="features" className="tc-section">
          ...
          <div className="tc-grid tc-grid-3">
            ...
            <div className="tc-card">
              ...
              <ul className="tc-list">
                <li>Estimated fill percentage</li>
            ...
            <div className="tc-card">
              <h3>Retro Dispaly</h3>
              <p>
                The display features a ui that displays a pointcloud heatmap, insights into the Computer Vision. 
              </p>
              <ul className="tc-list">
                <li>Heatmap</li>
                <li>Blue: Further</li>
        ...
        <section className="tc-section">
          ...
          <div className="tc-steps">
            ...
            <div className="tc-step">
              ...
              <div className="tc-step-body">
                <h3>Display on touchscreen</h3>
                <p>
                  From the pi we also display the pointcloud and insights on a retro themed touchscreen display mounted on the trashcan.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="tc-section">
          ...
          <div className="tc-grid tc-grid-4">
            ...
            <div className="tc-metric-card">
              ...
              <span className="tc-metric-value">number #</span>
              <span className="tc-metric-caption">of total detections</span>
            </div>
            <div className="tc-metric-card">
        ...
        <section className="tc-section">
          ...
          <div className="tc-tech-grid">
            <div className="tc-card tc-tech-card">
              <h3>Hardware</h3>
              <ul className="tc-list">
                <li>Raspberry Pi Zero 5</li>
                <li>Intelsense Camera</li>
                <li>Addressable touch screen Display</li>
      ...
      <footer className="tc-footer">
        <p>
          Built with love as <span className="tc-highlight">TrashCam</span> —
